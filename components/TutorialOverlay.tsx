  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
      ...
      <div
        ...
        style={{ background: "#FFFFFF", border: "1px solid #E4E6EB", boxShadow: "0 20px 60px rgba(15,23,42,0.16)", animation: "tutFadeIn 0.3s ease-out forwards" }}
      >
        {/* Header — correct logo */}
        ...
        <div className="px-5 pt-4 pb-1">
          <span className="text-xs font-semibold" style={{ color: "#65676B" }}>
        ...
        <div className="px-5 py-3">
          <h2 className="text-base font-bold mb-2" style={{ color: "#1C1E21" }}>{step.title}</h2>
          <p className="text-sm leading-relaxed" style={{ color: "#1C1E21" }}>
            {step.message}
          </p>
          {step.highlight && (
