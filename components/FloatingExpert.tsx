...
type Step = "idle" | "open" | "confirm" | "success" | "no_credits";
...
export default function FloatingExpert() {
  ...
  function open() {
    if (!canBook) { setStep("no_credits"); return; }
    setStep("open");
  }
    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          boxShadow: "0 4px 24px #F5A62350",
        }}
        aria-label="Book a live consultation"
      >
      ...
      {step !== "idle" && (
        ...
        >
          <div
            className="w-full max-w-md rounded-2xl border border-gray-700 overflow-hidden"
