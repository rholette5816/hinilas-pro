    ...
    >
      <div className="w-full md:max-w-md rounded-t-2xl md:rounded-2xl border border-gray-700 overflow-y-auto max-h-[92vh]" style={{ background: "#0F172A" }}>
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-800">
          <div>
            <p className="text-white font-bold text-sm">Pay via GCash</p>
        ...
        {!done ? (
          <div className="p-5 space-y-4">
            ...
            <div className="rounded-xl overflow-hidden border border-gray-800 bg-blue-600 flex flex-col items-center py-5 px-4">
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                <button
                  ...
                  className="text-blue-200 hover:text-white text-xs px-2 py-0.5 rounded border border-blue-400/40 hover:border-blue-400/80 transition-all"
                >Copy</button>
              </div>
              <div className="flex items-center gap-2 mt-1">
            ...
            {/* Amount summary */}
            <div className="flex items-center justify-between rounded-xl px-4 py-3" style={{ background: "#0A0F1A", border: "1px solid #1F2937" }}>
              <div>
                <p className="text-white font-bold text-sm">{label} — {credits} credits</p>
                <p className="text-gray-500 text-xs">Never expires · adds to balance</p>
              </div>
            ...
            <p className="text-gray-600 text-xs text-center">Credits added after we verify your payment. Usually within a few hours.</p>
          </div>
        ) : (
          <div className="p-8 text-center space-y-3">
            ...
            <p className="text-gray-400 text-sm">We received your payment for <strong className="text-white">{credits} credits</strong>. Credits will be added after verification.</p>
