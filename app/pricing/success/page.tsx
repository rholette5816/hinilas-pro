  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ background: "#0A0F1A" }}>
      <div className="text-center max-w-sm px-6">
        ...
        <h1 className="text-2xl font-bold text-[#1c1e21] mb-3">Payment Successful!</h1>
        <p className="text-gray-400 text-sm mb-2">
          Your <span className="text-[#1c1e21] font-semibold">{PLAN_LABELS[plan] || plan}</span> is now active.
        </p>
