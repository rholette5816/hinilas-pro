  ...
  return (
    <div className="min-h-screen px-6 py-12" style={{ background: "#F0F2F5" }}>
      <div className="mx-auto max-w-2xl rounded-2xl border bg-white p-8" style={{ borderColor: "#E4E6EB" }}>
        <div className="mb-10">
          <h1 className="mb-2 text-3xl font-black text-[#050505]">Privacy Policy</h1>
          <p className="text-sm text-[#8a8d91]">Last updated: April 2025</p>
        </div>

        <div className="space-y-8 text-sm leading-7 text-slate-600">
          <section>
            <h2 className="mb-2 text-base font-bold text-[#1c1e21]">1. Introduction</h2>
          ...
          <section>
            <h2 className="mb-2 text-base font-bold text-[#1c1e21]">2. Information We Collect</h2>
          ...
          <section>
            <h2 className="mb-2 text-base font-bold text-[#1c1e21]">3. How We Use Your Information</h2>
            <ul className="list-disc space-y-1 pl-5">
          ...
          <section>
            <h2 className="mb-2 text-base font-bold text-[#1c1e21]">4. Data Storage</h2>
          ...
          <section>
            <h2 className="mb-2 text-base font-bold text-[#1c1e21]">5. Third-Party Services</h2>
            <p>We use the following third-party services:</p>
            <ul className="mt-2 list-disc space-y-1 pl-5">
              <li><strong className="text-[#1c1e21]">Google OAuth</strong> - for sign-in</li>
              <li><strong className="text-[#1c1e21]">Facebook Login</strong> - for sign-in</li>
              <li><strong className="text-[#1c1e21]">Supabase</strong> - for database and storage</li>
              <li><strong className="text-[#1c1e21]">Resend</strong> - for transactional emails</li>
              <li><strong className="text-[#1c1e21]">Vercel</strong> - for hosting</li>
              <li><strong className="text-[#1c1e21]">OpenAI</strong> - for AI-generated content</li>
            </ul>
          </section>

          <section>
            <h2 className="mb-2 text-base font-bold text-[#1c1e21]">6. Data Sharing</h2>
          ...
          <section>
            <h2 className="mb-2 text-base font-bold text-[#1c1e21]">7. Your Rights</h2>
          ...
          <section>
            <h2 className="mb-2 text-base font-bold text-[#1c1e21]">8. Cookies</h2>
            <p>We use session cookies to keep you logged in. We do not use tracking or advertising cookies.</p>
          </section>

          <section>
            <h2 className="mb-2 text-base font-bold text-[#1c1e21]">9. Children&apos;s Privacy</h2>
            <p>Hinilas Pro is not intended for users under the age of 13. We do not knowingly collect data from children.</p>
          </section>

          <section>
            <h2 className="mb-2 text-base font-bold text-[#1c1e21]">10. Contact</h2>
            <p>For any privacy-related questions or requests, contact us at:</p>
            <p className="mt-1 font-semibold text-[#1c1e21]">support@hinilas.pro</p>
          </section>
        </div>

        <div className="mt-12 border-t border-slate-200 pt-8">
          <p className="text-center text-xs text-[#8a8d91]">2026 Hinilas Pro - Basta Mag Ads Hilas</p>
        </div>
      </div>
    </div>
  );
