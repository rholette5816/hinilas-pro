  ...
  return `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 560px; margin: 0 auto; padding: 24px; color: #1F2937;">
      ...
      <p style="margin: 32px 0;">
        <a href="${APP_URL}/angles" style="display: inline-block; background: #D97706; color: #000; font-weight: bold; padding: 14px 28px; border-radius: 8px; text-decoration: none; font-size: 14px;">Generate My Angles &rarr;</a>
      </p>
...
export async function GET(req: NextRequest) {
  ...
  if (!acquireCronLock("dropoff-emails")) {
  ...
  try {
    ...
    for (const userId of candidateUserIds) {
      ...
      try {
        ...
        console.error("[cron-dropoff-emails] user processing error:", error);
    ...
    console.error("[cron-dropoff-emails] cron error:", error);
