              ...
              {!selectedAngle ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="w-full text-white py-3 rounded-xl text-sm font-semibold mb-6 transition-opacity hover:opacity-90 disabled:opacity-40 flex items-center justify-center gap-2"
