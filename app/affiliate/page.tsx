      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-5 items-start">
          ...
          <a
            ...
            className="flex items-center justify-between gap-3 rounded-2xl p-5 transition-opacity hover:opacity-90"
            style={{ background: "#0F172A", border: "1px solid rgba(217,119,6,0.4)", textDecoration: "none" }}
          >
            <div>
              <p className="text-xs font-bold uppercase tracking-widest mb-1" style={{ color: "#D97706" }}>Investor Deck</p>
              <p className="text-sm font-black text-white">View the Hinilas Pro Pitch</p>
              <p className="text-xs mt-1" style={{ color: "#94A3B8" }}>The business case, market opportunity, and growth direction.</p>
            </div>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#D97706" strokeWidth="2.5" className="shrink-0"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>
          </a>

          <a
            href="/affiliateprog.html"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-between gap-3 rounded-2xl p-5 transition-opacity hover:opacity-90"
            style={{ background: "#0F172A", border: "1px solid rgba(217,119,6,0.4)", textDecoration: "none" }}
          >
            <div>
              <p className="text-xs font-bold uppercase tracking-widest mb-1" style={{ color: "#D97706" }}>Partner Program</p>
              <p className="text-sm font-black text-white">See How the Program Works</p>
              <p className="text-xs mt-1" style={{ color: "#94A3B8" }}>Income streams, projections, and how to get started.</p>
            </div>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#D97706" strokeWidth="2.5" className="shrink-0"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>
          </a>
